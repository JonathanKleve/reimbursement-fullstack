...
* I supposse I had forgotten that SQL can enforce and allow you to implement referential integrity aspects. My past experience with SQL only touched on the surface level aspects of SQL i.e. query syntax with only brief mentions of the deeper functionality and database engineering aspects.
